  ...
  return (
    <div className="border p-10 space-y-5">
      ...
      <div>
        {pedido.map(platillo => (
          <div key={platillo.id} className='py-3 flex border-b last-of-type:border-0 items-center'>
            <div className="w-32">
              <Image width={400} height={500} src={`/assets/img/${platillo.imagen}.jpg`} alt={`Imgen del platillo ${platillo.nombre}`} />
            </div>
      ...
      <div className="md:flex md:items-center md:justify-between my-10">
        ...
        <button className="bg-indigo-600 md:mt-0 py-3 px-10 uppercase hover:bg-indigo-800 text-white font-bold rounded-lg"
          type="button"
